...
export type AdminSection = 'dashboard' | 'settings' | 'reminders-notifications' | 'maintenance' | 'leave' | 'leave-types' | 'users' | 'departments' | 'projects' | 'project-activities' | 'components'
