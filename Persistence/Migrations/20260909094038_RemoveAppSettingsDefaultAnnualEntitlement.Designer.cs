...
namespace Persistence.Migrations
{
    ...
    [Migration("20260909094038_RemoveAppSettingsDefaultAnnualEntitlement")]
    partial class RemoveAppSettingsDefaultAnnualEntitlement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.AppSettings", b =>
                {
                    ...
                    b.Property<string>("TimesheetSubmissionDeadlineDay")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TimesheetSubmissionDeadlineTime")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("WeeklyHoursTarget")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("WorkingDaysCustom")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.ProjectActivityAssignment", b =>
                {
                    ...
                    b.ToTable("ProjectActivityAssignments");
                });
            ...
            modelBuilder.Entity("Domain.ProjectComponentAssignment", b =>
                {
                    b.Property<int>("ProjectId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProjectComponentAssignments");
                });

            modelBuilder.Entity("Domain.ProjectDepartment", b =>
                {
                    b.Property<int>("ProjectId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.StoredFile", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.ProjectComponentAssignment", b =>
                {
                    b.HasOne("Domain.ProjectComponent", "Component")
                        .WithMany("ProjectAssignments")
            ...
            modelBuilder.Entity("Domain.TimesheetEntry", b =>
                {
                    ...
                    b.HasOne("Domain.ProjectComponent", "ProjectComponent")
                        .WithMany()
